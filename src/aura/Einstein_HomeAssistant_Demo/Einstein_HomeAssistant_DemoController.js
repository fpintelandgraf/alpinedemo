            ...
            if(record && record != "" && record != "name here"){
                switch (insight){
                    ...
                    case 'Acct - No Communication':
                        insightTitle = "No communication at " + recordName;
                        insightSubtitle = "There’s usually communication about this account every 5 days. So far, there hasn’t been any in 8 days.";
                        trend = "down";
                        break;
