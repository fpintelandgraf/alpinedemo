trigger SetOpportunityPrediction on Opportunity (before insert, before update) {
    ...
    for (Opportunity sObj: Trigger.new) {
        ...
        if (sObj.Exec_Meeting__c == false && sObj.Interactive_Demo__C == false) {
            ...
            sObj.ED_Leading_Causes__c = '+ 12.65 because Lead Source is Fields Sales<br>+ 10.23 because Lead Source is Fields Sales and Region is Mid-Atlantic<br>- 7.55 because Region is Mid-Atlantic and Sales Stage Count is 5 to 7<br>+ ' + otherFactors.setScale(3) + ' because of other factors<br>from the baseline, + ' + base_ttc.setScale(3);
            ...
            sObj.ED_Leading_Causes__c = '- 15.65 because Exec Meeting to true<br>+ 12.65 because Lead Source is Fields Sales<br>+ 10.23 because Lead Source is Fields Sales and Region is Mid-Atlantic<br>- 7.55 because Region is Mid-Atlantic and Sales Stage Count is 5 to 7<br>+ ' + otherFactors.setScale(3) + ' because of other factors<br>from the baseline, + ' + base_ttc.setScale(3);
            ...
            sObj.ED_Leading_Causes__c = '- 5.65 because Interactive Demo to true<br>+ 12.65 because Lead Source is Fields Sales<br>+ 10.23 because Lead Source is Fields Sales and Region is Mid-Atlantic<br>- 7.55 because Region is Mid-Atlantic and Sales Stage Count is 5 to 7<br>+ ' + otherFactors.setScale(3) + ' because of other factors<br>from the baseline, + ' + base_ttc.setScale(3);
            sObj.ED_Prescription__c = '- 15.65 if you change Exec Meeting to true';
        } else {
            sObj.ED_Outcome__c = actualTTC;
            sObj.ED_Leading_Causes__c = '- 15.65 because Exec Meeting to true<br>- 5.65 because Interactive Demo to true<br>+ 12.65 because Lead Source is Fields Sales<br>+ 10.23 because Lead Source is Fields Sales and Region is Mid-Atlantic<br>+ ' + otherFactors.setScale(3) + ' because of other factors<br>from the baseline, + ' + base_ttc.setScale(3);
